...
const rows: TrnFilterRow[] = [
  {
    date: D('2026-07-01T09:00'),
    kind: 'expense',
    categoryId: 'c-market',
    desc: 'Migros haftalık alışveriş',
    tagIds: ['t-zorunlu', 't-aile'],
    amount: -450
  },
  {
    date: D('2026-07-15T23:30'),
    kind: 'expense',
    categoryId: 'c-kafe',
    desc: 'Starbucks',
    tagIds: ['t-keyfi'],
  ...
  {
    date: D('2026-06-05T10:00'),
    kind: 'transfer',
    categoryId: 'transfer',
    desc: 'Vadesizden birikime',
    tagIds: [],
    amount: -5000
  },
  {
    date: D('2026-06-01T00:00'),
    kind: 'adjustment',
    categoryId: 'adjustment',
    desc: 'Açılış bakiyesi',
    tagIds: [],
    amount: 12000
  }
]
    ...
    const dupRows: TrnFilterRow[] = [
      {
        date: D('2026-07-01T09:00'),
        kind: 'expense',
        categoryId: 'c-diger-market',
        desc: 'A',
        tagIds: [],
        amount: -10
      },
      {
        date: D('2026-07-02T09:00'),
        kind: 'expense',
        categoryId: 'c-diger-fatura',
        desc: 'B',
        tagIds: [],
        amount: -20
      }
