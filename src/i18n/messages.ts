...
export const messages = {
  tr: {
    ...
    settings: {
      ...
      openLogsError: 'Log klasörü açılamadı',
      checkUpdates: 'Güncellemeleri denetle',
      updateNone: 'En güncel sürümü kullanıyorsun',
      updateUnsupported: 'Güncelleme yalnız masaüstü uygulamasında geçerli',
      ...
      ratesStatusDesc: 'Hangi kaynaktan, ne zamanın kuru',
      ratesRateDate: 'Kur tarihi',
      ratesFetchedAt: 'Son çekim',
      ratesSource: 'Kaynak',
      ratesCount: 'Para birimi',
      ratesRefresh: 'Şimdi yenile',
      ratesRefreshed: 'Kurlar güncellendi',
      ratesRefreshFailed: 'Kurlar çekilemedi — bağlantını kontrol et',
      ratesNever: 'Henüz kur çekilmedi',
      ratesFresh: 'Güncel',
      ratesStale: 'Bayat',
  ...
  en: {
    ...
    settings: {
      ...
      openLogsError: 'Could not open log folder',
      checkUpdates: 'Check for updates',
      updateNone: 'You are on the latest version',
      updateUnsupported: 'Updates are only available in the desktop app',
      ...
      rateSourceSaveFailed: 'Could not save rate source',
      ratesStatus: 'Rate status',
      ratesStatusDesc: 'Which source, rates from when',
      ratesRateDate: 'Rate date',
      ratesFetchedAt: 'Last fetched',
      ratesSource: 'Source',
      ratesCount: 'Currencies',
      ratesRefresh: 'Refresh now',
      ratesRefreshed: 'Rates updated',
      ratesRefreshFailed: 'Could not fetch rates — check your connection',
      ratesNever: 'No rates fetched yet',
      ratesFresh: 'Up to date',
      ratesStale: 'Stale',
  ...
  ru: {
    ...
    settings: {
      ...
      openLogsError: 'Не удалось открыть папку логов',
      checkUpdates: 'Проверить обновления',
      updateNone: 'У вас последняя версия',
      updateUnsupported: 'Обновления доступны только в десктоп-приложении',
      ...
      rateSourceSaveFailed: 'Не удалось сохранить источник курсов',
      ratesStatus: 'Состояние курсов',
      ratesStatusDesc: 'Какой источник, на какую дату',
      ratesRateDate: 'Дата курса',
      ratesFetchedAt: 'Последнее обновление',
      ratesSource: 'Источник',
      ratesCount: 'Валют',
      ratesRefresh: 'Обновить сейчас',
      ratesRefreshed: 'Курсы обновлены',
      ratesRefreshFailed: 'Не удалось получить курсы — проверьте соединение',
      ratesNever: 'Курсы ещё не загружались',
      ratesFresh: 'Актуальны',
      ratesStale: 'Устарели',
