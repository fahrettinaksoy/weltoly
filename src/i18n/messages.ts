...
export const messages = {
  tr: {
    ...
    settings: {
      ...
      removePin: 'PIN kaldır', pinRemoved: 'PIN kaldırıldı', localization: 'Yerelleştirme',
      groupTheme: 'Tema ve renkler', groupAccount: 'Hesap ve güvenlik', groupData: 'Yedekleme ve veri',
    ...
    common: { back: 'Geri',
      ...
      save: 'Kaydet', cancel: 'Vazgeç', delete: 'Sil', edit: 'Düzenle', add: 'Ekle', close: 'Kapat', required: 'Zorunlu alan', list: 'Liste',
    },
    dashboard: {
      title: 'Panel',
      ...
      netWorth: 'Net varlık',
      thisMonth: 'Bu ay', vsPrevMonth: 'Geçen aya göre',
      whereIsMoney: 'Para nerede duruyor', whereIsMoneyDesc: 'Varlığın cüzdan türlerine dağılımı',
      creditRisk: 'Kredi kartı kullanımı', creditRiskDesc: 'Kartların limit doluluğu',
      recentTrns: 'Son işlemler', recentTrnsDesc: 'Hareket olan son {n} gün',
      projectState: 'Defter durumu', projectStateDesc: 'Kayıtlarının genel görünümü',
      unusedN: '{n} tanesi kullanılmıyor', trnSpan: 'Kayıt aralığı',
    ...
    stat: {
      ...
      net: 'Net', breakdown: 'Kategori kırılımı', breakdownDesc: 'Kök kategorilere dağılım',
      breakdownDrillDesc: 'Alt kategorilere dağılım', allCategories: 'Tüm kategoriler',
      drillHint: '{name} alt kırılımını gör',
      trend: 'Gelir & gider seyri', trendDesc: 'Aralık aralık karşılaştırma',
      filters: 'Süzgeçler', vsPrevRange: 'Önceki aralığa göre',
      byTag: 'Etiket dağılımı', byTagDesc: 'Tutarların etiketlere dağılımı', untagged: 'Etiketsiz',
      byTagNote: 'Bir işlem birden çok etiket taşıyabilir; her oran aralığın toplamına göredir ve oranların toplamı %100 etmez.',
      noData: 'Bu aralıkta veri yok', filterWallets: 'Cüzdan filtresi', filterTags: 'Etiket filtresi',
    },
    walletDetail: {
      nSelected: '{n} seçili',
      filterDate: 'Tarih aralığı', filterAll: 'Tümü', filterMinAmount: 'En az', filterTags: 'Etiket', filterDesc: 'Ara',
      type: 'Tür',
      noFilterMatch: 'Süzgece uyan işlem yok', clearFilters: 'Süzgeçleri temizle',
      tabSummary: 'Özet',
      balanceTrendDesc: 'Dönem içindeki bakiye değişimi', byCategoryDesc: 'Giderlerin kategorilere dağılımı',      status: 'Durum',
      notFound: 'Cüzdan bulunamadı', period: 'Dönem', days: 'Son {n} gün', allTime: 'Tümü',
      lastTrn: 'Son işlem', totalTrns: 'Toplam işlem',
      net: 'Net', balanceTrend: 'Bakiye seyri', byCategory: 'Kategori dağılımı',
      transactions: 'İşlemler', noTrns: 'Bu dönemde işlem yok', noExpense: 'Bu dönemde gider yok',
      creditUsage: 'Limit kullanımı', available: 'Kullanılabilir',
      unsetDefault: 'Varsayılandan çıkar', tags: 'Etiketler',
      transfer: 'Transfer', adjustment: 'Düzeltme', otherCategories: 'Diğer ({count})',
      byCategoryDrillDesc: 'Alt kategorilere dağılım', allCategories: 'Tüm kategoriler',
      vsPrevPeriod: 'Önceki döneme göre',
      byTag: 'Etiket dağılımı', byTagDesc: 'Giderlerin etiketlere dağılımı', untagged: 'Etiketsiz',
    ...
    wallets: {
      ...
      search: 'Cüzdan ara', noResults: 'Eşleşen cüzdan yok',
    ...
    categories: {
      ...
      name: 'Ad', icon: 'İkon', color: 'Renk', description: 'Açıklama', parent: 'Üst kategori', noParent: 'Yok (kök)',
      ...
      search: 'Kategori ara', noResults: 'Eşleşen kategori yok', unused: 'Henüz kullanılmadı',
      ...
      added: 'Kategori eklendi', updated: 'Kategori güncellendi',
      errors: { saveFailed: 'Kategori kaydedilemedi', deleteFailed: 'Kategori silinemedi' },
    },
    tags: {
      title: 'Etiketler', add: 'Etiket ekle', name: 'Ad', color: 'Renk', description: 'Açıklama',
      ...
      search: 'Etiket ara', noResults: 'Eşleşen etiket yok',
      ...
      added: 'Etiket eklendi', updated: 'Etiket güncellendi',
    ...
    trns: {
      ...
      added: 'İşlem eklendi', updated: 'İşlem güncellendi',
  ...
  en: {
    ...
    settings: {
      ...
      removePin: 'Remove PIN', pinRemoved: 'PIN removed', localization: 'Localization',
      groupTheme: 'Theme & colors', groupAccount: 'Account & security', groupData: 'Backup & data',
    ...
    common: { back: 'Back',
      ...
      save: 'Save', cancel: 'Cancel', delete: 'Delete', edit: 'Edit', add: 'Add', close: 'Close', required: 'Required', list: 'List',
    },
    dashboard: {
      title: 'Dashboard',
      netWorth: 'Net worth',
      thisMonth: 'This month', vsPrevMonth: 'vs last month',
      whereIsMoney: 'Where the money sits', whereIsMoneyDesc: 'Assets across wallet types',
      creditRisk: 'Credit card usage', creditRiskDesc: 'How full your limits are',
      recentTrns: 'Recent transactions', recentTrnsDesc: 'The last {n} days with activity',
      projectState: 'Ledger state', projectStateDesc: 'An overview of your records',
      unusedN: '{n} unused', trnSpan: 'Record range',
      noTrns: 'No transactions yet',
    },
    stat: {
      day: 'Day', week: 'Week', month: 'Month', year: 'Year',
      net: 'Net', breakdown: 'Breakdown', breakdownDesc: 'Spread across root categories',
      breakdownDrillDesc: 'Spread across subcategories', allCategories: 'All categories',
      drillHint: 'See breakdown of {name}',
      trend: 'Income & expense trend', trendDesc: 'Range-by-range comparison',
      filters: 'Filters', vsPrevRange: 'vs previous range',
      byTag: 'Breakdown by tag', byTagDesc: 'How amounts spread across tags', untagged: 'Untagged',
      ...
      noData: 'No data for this range', filterWallets: 'Filter by wallet', filterTags: 'Filter by tag',
    },
    walletDetail: {
      nSelected: '{n} selected',
      filterDate: 'Date range', filterAll: 'All', filterMinAmount: 'Min', filterTags: 'Tag', filterDesc: 'Search',
      type: 'Type',
      noFilterMatch: 'No transactions match the filters', clearFilters: 'Clear filters',
      tabSummary: 'Summary',
      balanceTrendDesc: 'Balance change over the period', byCategoryDesc: 'Expenses split by category',      status: 'Status',
      notFound: 'Wallet not found', period: 'Period', days: 'Last {n} days', allTime: 'All time',
      lastTrn: 'Last activity', totalTrns: 'Total transactions',
      net: 'Net', balanceTrend: 'Balance trend', byCategory: 'By category',
      transactions: 'Transactions', noTrns: 'No transactions in this period', noExpense: 'No expenses in this period',
      creditUsage: 'Credit usage', available: 'Available',
      unsetDefault: 'Unset default', tags: 'Tags',
      transfer: 'Transfer', adjustment: 'Adjustment', otherCategories: 'Other ({count})',
      byCategoryDrillDesc: 'Breakdown by subcategory', allCategories: 'All categories',
      vsPrevPeriod: 'vs previous period',
      byTag: 'Breakdown by tag', byTagDesc: 'How expenses spread across tags', untagged: 'Untagged',
    ...
    wallets: {
      ...
      search: 'Search wallets', noResults: 'No matching wallets',
    ...
    categories: {
      ...
      name: 'Name', icon: 'Icon', color: 'Color', description: 'Description', parent: 'Parent category', noParent: 'None (root)',
    ...
    tags: {
      ...
      search: 'Search tags', noResults: 'No matching tags',
      unused: 'Not used yet',
    ...
    trns: {
      ...
      added: 'Transaction added', updated: 'Transaction updated',
  ...
  ru: {
    ...
    settings: {
      ...
      removePin: 'Удалить PIN', pinRemoved: 'PIN удалён', localization: 'Локализация',
      groupTheme: 'Тема и цвета', groupAccount: 'Аккаунт и безопасность', groupData: 'Резервные копии и данные',
    ...
    common: { back: 'Назад',
      ...
      save: 'Сохранить', cancel: 'Отмена', delete: 'Удалить', edit: 'Изменить', add: 'Добавить', close: 'Закрыть', required: 'Обязательное поле', list: 'Список',
    },
    dashboard: {
      title: 'Панель',
      netWorth: 'Чистые активы',
      thisMonth: 'В этом месяце', vsPrevMonth: 'к прошлому месяцу',
      whereIsMoney: 'Где лежат деньги', whereIsMoneyDesc: 'Активы по типам кошельков',
      creditRisk: 'Использование карт', creditRiskDesc: 'Заполненность лимитов',
      recentTrns: 'Последние операции', recentTrnsDesc: 'Последние {n} дней с операциями',
      projectState: 'Состояние книги', projectStateDesc: 'Общий обзор записей',
      unusedN: 'не используется: {n}', trnSpan: 'Диапазон записей',
      noTrns: 'Пока нет операций',
    },
    stat: {
      day: 'День', week: 'Неделя', month: 'Месяц', year: 'Год',
      net: 'Нетто', breakdown: 'Разбивка', breakdownDesc: 'Распределение по корневым категориям',
      breakdownDrillDesc: 'Распределение по подкатегориям', allCategories: 'Все категории',
      drillHint: 'Показать разбивку: {name}',
      trend: 'Динамика доходов и расходов', trendDesc: 'Сравнение по периодам',
      filters: 'Фильтры', vsPrevRange: 'к предыдущему периоду',
      byTag: 'Разбивка по меткам', byTagDesc: 'Распределение сумм по меткам', untagged: 'Без метки',
      byTagNote: 'Операция может иметь несколько меток; каждая доля считается от итога периода, поэтому сумма долей не равна 100%.',
      noData: 'Нет данных за период', filterWallets: 'Фильтр по кошельку', filterTags: 'Фильтр по метке',
    },
    walletDetail: {
      nSelected: 'Выбрано: {n}',
      filterDate: 'Период', filterAll: 'Все', filterMinAmount: 'Мин.', filterTags: 'Метка', filterDesc: 'Поиск',
      type: 'Тип',
      noFilterMatch: 'Нет операций по фильтрам', clearFilters: 'Сбросить фильтры',
      tabSummary: 'Сводка',
      balanceTrendDesc: 'Изменение баланса за период', byCategoryDesc: 'Расходы по категориям',      status: 'Статус',
      notFound: 'Кошелёк не найден', period: 'Период', days: 'Последние {n} дней', allTime: 'Всё время',
      lastTrn: 'Последняя операция', totalTrns: 'Всего операций',
      net: 'Итого', balanceTrend: 'Динамика баланса', byCategory: 'По категориям',
      transactions: 'Операции', noTrns: 'Нет операций за период', noExpense: 'Нет расходов за период',
      creditUsage: 'Использование лимита', available: 'Доступно',
      unsetDefault: 'Убрать по умолчанию', tags: 'Метки',
      transfer: 'Перевод', adjustment: 'Корректировка', otherCategories: 'Прочие ({count})',
      byCategoryDrillDesc: 'Разбивка по подкатегориям', allCategories: 'Все категории',
    ...
    wallets: {
      ...
      name: 'Название', type: 'Тип', currency: 'Валюта', color: 'Цвет', creditLimit: 'Кредитный лимит', description: 'Описание', pickIcon: 'Выбрать иконку', resetIcon: 'По типу',
      ...
      search: 'Поиск кошельков', noResults: 'Совпадений нет',
      ...
      setDefault: 'Сделать кошельком по умолчанию', default: 'Кошелёк по умолчанию',
      defaultMovedFrom: 'Сейчас по умолчанию «{name}» — после сохранения станет этот.',
      chart: { other: 'Прочие ({count})' },
      deleted: 'Кошелёк удалён',
      added: 'Кошелёк добавлен', updated: 'Кошелёк обновлён',
    ...
    categories: {
      ...
      name: 'Название', icon: 'Иконка', color: 'Цвет', description: 'Описание', parent: 'Родительская категория', noParent: 'Нет (корень)',
      ...
      search: 'Поиск категорий', noResults: 'Совпадений нет', unused: 'Ещё не используется',
      ...
      added: 'Категория добавлена', updated: 'Категория обновлена',
      errors: { saveFailed: 'Не удалось сохранить категорию', deleteFailed: 'Не удалось удалить категорию' },
    },
    tags: {
      title: 'Метки', add: 'Добавить метку', name: 'Название', color: 'Цвет', description: 'Описание',
      ...
      search: 'Поиск меток', noResults: 'Совпадений нет',
      ...
      added: 'Метка добавлена', updated: 'Метка обновлена',
    ...
    trns: {
      ...
      added: 'Операция добавлена', updated: 'Операция обновлена',
